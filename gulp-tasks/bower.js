...
const bowerFiles = function (gulp) {
  ...
  let bowerJS = gulp.src(mBower)
    ...
    .pipe(vPaths(function (p) {
      console.log(`${ME.d}[${C.O}BOWER${C.N}] ${C.W}Adding${C.N} ${C.Y}JS${C.N}: [${p}]`);
  ...
  let bowerCSS = gulp.src(mBower)
    ...
    .pipe(vPaths(function (p) {
      console.log(`${ME.d}[${C.O}BOWER${C.N}] ${C.W}Adding${C.N} ${C.Y}CSS${C.N}: [${p}]`);
      return Promise.resolve(p);
    }))
    ...
    .pipe(vPaths(function (p) {
      console.log(`${ME.d}[${C.O}BOWER${C.N}] ${C.W}Bundled${C.N} ${C.Y}CSS${C.N}: [${p}]`);
      return Promise.resolve(p);
    }))
    //  Write banners
    // .pipe(headfoot.header(ME.Banner.header))
  ...
  let bowerFonts = gulp.src(mBower)
    .pipe(filter(['**/fonts/**/*.*']))
    .pipe(vPaths(function (p) {
      console.log(`${ME.d}[${C.O}BOWER${C.N}] ${C.W}Copying${C.N} ${C.Y}FONT${C.N}: [${p}]`);
      return Promise.resolve(p);
    }))
  ...
  let webFonts = gulp.src(mBower)
    ...
    .pipe(vPaths(function (p) {
      console.log(`${ME.d}[${C.O}BOWER${C.N}] ${C.W}Copying${C.N} ${C.Y}WEBFONT${C.N}: [${p}]`);
      return Promise.resolve(p);
    }))
  ...
  let bowerImg = gulp.src(mBower)
    ...
    .pipe(vPaths(function (p) {
      console.log(`${ME.d}[${C.O}BOWER${C.N}] ${C.W}Copying${C.N} ${C.Y}IMG${C.N}: [${p}]`);
      return Promise.resolve(p);
    }))
